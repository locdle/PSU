        ...
        Stmt s1 = new Seq(new VarDecl("l", new Cons(new Int(1),
                    ...
                    new Seq(new VarDecl("r", new Nil()),
                        new Seq(new Print(new Var("l")),
                            new Seq (new Call("map", new Expr[]{new Lambda("x", new Mult(new Var("x"), new Int(2))), new Var("l"),new Var("r")}),
                                new Seq(new Print(new Var("r")),
                                        new Seq(new Call("map", new Expr[]{new Lambda("x", new Plus(new Var("x"), new Int(1))), new Var("r"),new Var("l")}),
                                                new Print(new Var("l"))))))));
