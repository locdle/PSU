...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0xa697de2c (decimal -1499996628)
	set	_packageName,r2
	set	0xa697de2c,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_semaphoreIsEmpty
	set	_Global_semaphoreIsEmpty,r1
	store	r1,[r14+-216]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_semaphoreIsFull
	set	_Global_semaphoreIsFull,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_426 = &_Global_semaphoreIsEmpty
	set	_Global_semaphoreIsEmpty,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_432 = &_Global_semaphoreIsFull
	set	_Global_semaphoreIsFull,r1
	store	r1,[r14+-16]
!   Send message Up
	load	[r14+-16],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_451 = &_Global_semaphoreIsFull
	set	_Global_semaphoreIsFull,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_457 = &_Global_semaphoreIsEmpty
	set	_Global_semaphoreIsEmpty,r1
	store	r1,[r14+-16]
!   Send message Up
	load	[r14+-16],r1
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-60]
!   Data Move: _temp_651 = *_temp_653  (sizeInBytes=4)
	load	[r14+-60],r1
	load	[r1],r1
	store	r1,[r14+-68]
!   if _temp_651 != 1 then goto _Label_648		(int)
	load	[r14+-68],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_648
...
!   _temp_655 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-52]
!   Move address of _temp_655 [LEFT ] into _temp_656
!     make sure index expr is >= 0
	load	[r14+-80],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: _temp_654 = *_temp_656  (sizeInBytes=4)
	load	[r14+-48],r1
	load	[r1],r1
	store	r1,[r14+-56]
!   if _temp_654 == 2 then goto _Label_648		(int)
	load	[r14+-56],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_648
...
!   _temp_658 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-40]
!   Move address of _temp_658 [RIGHT ] into _temp_659
!     make sure index expr is >= 0
	load	[r14+-84],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: _temp_657 = *_temp_659  (sizeInBytes=4)
	load	[r14+-36],r1
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_657 == 2 then goto _Label_648		(int)
	load	[r14+-44],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_648
...
!   _temp_660 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_660 [p ] into _temp_661
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_689 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-52]
!   Move address of _temp_689 [p ] into _temp_690
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: *_temp_690 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-48],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_696 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_696 [p ] into _temp_697
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_695 = *_temp_697  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_695 == 2 then goto _Label_694		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_694
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_721 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_723 = &_Global_mon
	set	_Global_mon,r1
	store	r1,[r14+-20]
!   Prepare Argument: offset=12  value=LEFT  sizeInBytes=4
	load	[r14+-48],r1
	store	r1,[r15+4]
!   Send message Test
	load	[r14+-20],r1
...
!   _temp_724 = &_Global_mon
	set	_Global_mon,r1
	store	r1,[r14+-16]
!   Prepare Argument: offset=12  value=RIGHT  sizeInBytes=4
	load	[r14+-52],r1
	store	r1,[r15+4]
!   Send message Test
	load	[r14+-16],r1
