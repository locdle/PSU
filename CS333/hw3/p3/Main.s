...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_59 = _StringConst_14
	set	_StringConst_14,r1
	store	r1,[r14+-248]
!   _temp_60 = &_Global_customer
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_62 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-236]
!   _temp_63 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-232]
!   Move address of _temp_63 [0 ] into _temp_64
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_65 = _StringConst_15
	set	_StringConst_15,r1
	store	r1,[r14+-224]
!   _temp_66 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-220]
!   Move address of _temp_66 [1 ] into _temp_67
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_68 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-212]
!   _temp_69 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-208]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_71 = _StringConst_16
	set	_StringConst_16,r1
	store	r1,[r14+-200]
!   _temp_72 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-196]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_74 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-188]
!   _temp_75 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-184]
!   Move address of _temp_75 [2 ] into _temp_76
!     make sure index expr is >= 0
	mov	2,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_77 = _StringConst_17
	set	_StringConst_17,r1
	store	r1,[r14+-176]
!   _temp_78 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-172]
!   Move address of _temp_78 [3 ] into _temp_79
!     make sure index expr is >= 0
	mov	3,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_80 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-164]
!   _temp_81 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-160]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_83 = _StringConst_18
	set	_StringConst_18,r1
	store	r1,[r14+-152]
!   _temp_84 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-148]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_86 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-140]
!   _temp_87 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-136]
!   Move address of _temp_87 [4 ] into _temp_88
!     make sure index expr is >= 0
	mov	4,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_89 = _StringConst_19
	set	_StringConst_19,r1
	store	r1,[r14+-128]
!   _temp_90 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-124]
!   Move address of _temp_90 [5 ] into _temp_91
!     make sure index expr is >= 0
	mov	5,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_92 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-116]
!   _temp_93 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-112]
!   Move address of _temp_93 [5 ] into _temp_94
!     make sure index expr is >= 0
	mov	5,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_95 = _StringConst_20
	set	_StringConst_20,r1
	store	r1,[r14+-104]
!   _temp_96 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-100]
!   Move address of _temp_96 [6 ] into _temp_97
!     make sure index expr is >= 0
	mov	6,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_98 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-92]
!   _temp_99 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-88]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_104 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-68]
!   _temp_105 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-64]
!   Move address of _temp_105 [7 ] into _temp_106
!     make sure index expr is >= 0
	mov	7,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_107 = _StringConst_22
	set	_StringConst_22,r1
	store	r1,[r14+-56]
!   _temp_108 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-52]
!   Move address of _temp_108 [8 ] into _temp_109
!     make sure index expr is >= 0
	mov	8,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_110 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-44]
!   _temp_111 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-40]
!   Move address of _temp_111 [8 ] into _temp_112
!     make sure index expr is >= 0
	mov	8,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_113 = _StringConst_23
	set	_StringConst_23,r1
	store	r1,[r14+-32]
!   _temp_114 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-28]
!   Move address of _temp_114 [9 ] into _temp_115
!     make sure index expr is >= 0
	mov	9,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_116 = _function_37_GetHairCut
	set	_function_37_GetHairCut,r1
	store	r1,[r14+-20]
!   _temp_117 = &_Global_customer
	set	_Global_customer,r1
	store	r1,[r14+-16]
!   Move address of _temp_117 [9 ] into _temp_118
!     make sure index expr is >= 0
	mov	9,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! ===============  FUNCTION GetHairCut  ===============
! 
_function_37_GetHairCut:
	push	r14
	mov	r15,r14
	push	r13
	set	_RoutineDescriptor__function_37_GetHairCut,r1
	push	r1
	mov	7,r1
_Label_417:
	push	r0
...
! Routine Descriptor
! 
_RoutineDescriptor__function_37_GetHairCut:
	.word	_sourceFileName
	.word	_Label_202
...
!   Next value...
	...
	store	r1,[r14+-56]
_Label_215:
!   Data Move: *_temp_213 = 0  (sizeInBytes=4)
	mov	0,r1
	load	[r14+-60],r2
	store	r1,[r2]
!   _temp_213 = _temp_213 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-60]
!   _temp_214 = _temp_214 + -1
	load	[r14+-56],r1
	add	r1,-1,r1
	store	r1,[r14+-56]
!   if intNotZero (_temp_214) then goto _Label_215
	load	[r14+-56],r1
	cmp	r1,r0
	bne	_Label_215
...
!   make sure array has size 10
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_211 = *_temp_216  (sizeInBytes=44)
	load	[r14+-52],r5
	load	[r14+-108],r4
	mov	11,r3
_Label_420:
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: *_temp_230 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-12],r2
	store	r1,[r2]
!   Increment the FOR-LOOP index variable and jump back
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-60]
!   Data Move: *_temp_256 = 4  (sizeInBytes=4)
	mov	4,r1
	load	[r14+-60],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-40]
!   Data Move: *_temp_265 = 5  (sizeInBytes=4)
	mov	5,r1
	load	[r14+-40],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-20]
!   Data Move: *_temp_270 = 6  (sizeInBytes=4)
	mov	6,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_295 = &status
	...
	add	r1,72,r1
	store	r1,[r14+-60]
!   Move address of _temp_295 [p ] into _temp_296
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-56]
!   Data Move: *_temp_296 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-56],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting >= chairs then goto _Label_299		(int)
	load	[r14+8],r1
	load	[r1+64],r1
	load	[r14+8],r2
	load	[r2+68],r2
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting != 1 then goto _Label_306		(int)
	load	[r14+8],r1
	load	[r1+64],r1
	mov	1,r2
	cmp	r1,r2
...
!   _temp_309 = &status
	...
	add	r1,72,r1
	store	r1,[r14+-24]
!   Move address of _temp_309 [p ] into _temp_310
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-20]
!   Data Move: *_temp_310 = 6  (sizeInBytes=4)
	mov	6,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting <= 0 then goto _Label_331		(int)
	load	[r14+8],r1
	load	[r1+64],r1
	mov	0,r2
	cmp	r1,r2
...
!   _temp_336 = 1		(4 bytes)
	...
	store	r1,[r14+-36]
!   Calculate and save the FOR-LOOP ending value
!   _temp_337 = waiting		(4 bytes)
	load	[r14+8],r1
	load	[r1+64],r1
	store	r1,[r14+-32]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_336  (sizeInBytes=4)
	load	[r14+-36],r1
	store	r1,[r14+-40]
_Label_332:
!   Perform the FOR-LOOP termination test
!   if i > _temp_337 then goto _Label_335		
	load	[r14+-40],r1
	load	[r14+-32],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_344 = 5 - waiting		(int)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_343  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-40]
_Label_339:
!   Perform the FOR-LOOP termination test
!   if i > _temp_344 then goto _Label_342		
	load	[r14+-40],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_375 = &status
	...
	add	r1,72,r1
	store	r1,[r14+-40]
!   Move address of _temp_375 [p ] into _temp_376
!     make sure index expr is >= 0
	load	[r14+-64],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: _temp_374 = *_temp_376  (sizeInBytes=4)
	load	[r14+-36],r1
	load	[r1],r1
	store	r1,[r14+-44]
